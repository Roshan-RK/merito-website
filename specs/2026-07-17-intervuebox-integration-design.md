...
9. Real webhook payload shape still unknown — user is setting up a temporary catcher (e.g. webhook.site) via the white-label dashboard directly to capture a real sample, independent of waiting on Krupal.
