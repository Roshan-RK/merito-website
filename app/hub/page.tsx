...
const OFFERINGS = [
  ...
  { n: "4", name: "References Feedback", tag: "Builds your profile", free: false, span: 3, benefit: "Let the people who've worked with you do the vouching.", body: "Invite managers, teammates, or clients to rate your soft skills across 5–6 parameters. Verified, structured references that carry the kind of credibility a CV never can.", cta: "Invite my references", href: "#pricing" },
